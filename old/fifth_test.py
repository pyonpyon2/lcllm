...
# 使い方:
#   python fifth_test.py file1.txt file2.txt ... --query "要約して" \
...
parser.add_argument("--ask_only", action="store_true", help="インデックス作成をスキップし、既存Chroma(永続化ディレクトリ)から検索のみ実行")
parser.add_argument("--collection_name", default="demo-lms-texts", help="Chromaのコレクション名（既定: demo-lms-texts）")
